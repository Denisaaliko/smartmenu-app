...
<head>
    ...
    <title>Kerkimi i produktit</title>
</head>
<body>
<div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" placeholder="Kerko Produkt" id="search">
...
<script>
    ...
    function table_post_row(res) {
       ...
       <tr>
        ...
        <tr>
           <td>` + (i + 1) + `</td>
              <td>` + res.produkt[i].Emer + `</td>
               <td>` + res.produkt[i].Çmim + `</td>
        </tr>`;
        }
        $('tbody').html(htmlView);
    }
